...
# merged  — персона СВЕДЕНА в athar_misc: отдельным источником не собирается,
#           её асары уходят в «прочих». Порог — покрытие ниже ~15% аятов: имя
#           вроде «Тафсир Аиши» на 5% аятов обещает тафсир, а даёт горсть
#           преданий, и таких персон было 25 из 40 (2026-08-14). Записи НЕ
#           удалены: разбор арабских приписок (match/exclude) — самое дорогое
#           здесь, и вернуть персону в отдельный источник = снять этот флаг
#           и пересобрать её вместе с athar_misc.
SCHOLARS = {
    ...
    "ibn_masud": {"merged": True, "name": "Тафсир Ибн Масуда", "nameAr": "تفسير ابن مسعود",
                  "match": ["عبد الله بن مسعود", "ابن مسعود"], "exclude": []},
    "ata":       {"merged": True, "name": "Тафсир Аты ибн Аби Рабаха", "nameAr": "تفسير عطاء",
    ...
    "abu_hurayra":{"merged": True, "name": "Тафсир Абу Хурайры", "nameAr": "تفسير أبي هريرة",
                  "match": ["أبي هريرة", "أبو هريرة"], "exclude": []},
    "kalbi":     {"merged": True, "name": "Тафсир аль-Кальби", "nameAr": "تفسير الكلبي",
                  "match": ["محمد بن السائب الكلبي", "الكلبي"], "exclude": []},
    "rabi_anas": {"merged": True, "name": "Тафсир ар-Раби ибн Анаса", "nameAr": "تفسير الربيع بن أنس",
                  "match": ["الربيع بن أنس"], "exclude": []},
    "ibn_ishaq": {"merged": True, "name": "Тафсир Ибн Исхака", "nameAr": "تفسير ابن إسحاق",
                  "match": ["محمد بن إسحاق", "ابن إسحاق"], "exclude": []},
    "muqatil_hayyan":{"merged": True, "name": "Тафсир Мукатиля ибн Хайяна", "nameAr": "تفسير مقاتل بن حيان",
                  "match": ["مقاتل بن حيان"], "exclude": []},
    "ali":       {"merged": True, "name": "Тафсир Али ибн Аби Талиба", "nameAr": "تفسير علي بن أبي طالب",
                  "match": ["علي بن أبي طالب"], "exclude": []},   # НЕ «علي بن أبي طلحة» — это путь передачи
    "ibn_umar":  {"merged": True, "name": "Тафсир Ибн Умара", "nameAr": "تفسير ابن عمر",
                  "match": ["عبد الله بن عمر", "ابن عمر"], "exclude": ["عبد الله بن عمرو"]},
    "aisha":     {"merged": True, "name": "Тафсир Аиши", "nameAr": "تفسير عائشة",
                  "match": ["عائشة"], "exclude": []},
    "shabi":     {"merged": True, "name": "Тафсир аш-Шаби", "nameAr": "تفسير الشعبي",
                  "match": ["عامر الشعبي", "الشعبي"], "exclude": []},
    "qurazi":    {"merged": True, "name": "Тафсир Мухаммада ибн Кааба аль-Куразый", "nameAr": "تفسير محمد بن كعب القرظي",
                  "match": ["محمد بن كعب القرظي", "محمد بن كعب"], "exclude": []},
    "nakhai":    {"merged": True, "name": "Тафсир Ибрахима ан-Нахаи", "nameAr": "تفسير إبراهيم النخعي",
                  "match": ["إبراهيم النخعي"], "exclude": []},
    "anas":      {"merged": True, "name": "Тафсир Анаса ибн Малика", "nameAr": "تفسير أنس بن مالك",
                  "match": ["أنس بن مالك", "أنس"], "exclude": []},
    "zayd_aslam":{"merged": True, "name": "Тафсир Зайда ибн Аслама", "nameAr": "تفسير زيد بن أسلم",
                  "match": ["زيد بن أسلم"], "exclude": []},
    "wahb":      {"merged": True, "name": "Тафсир Вахба ибн Мунаббиха", "nameAr": "تفسير وهب بن منبه",
                  "match": ["وهب بن منبه"], "exclude": []},
    "ata_khurasani":{"merged": True, "name": "Тафсир Аты аль-Хурасани", "nameAr": "تفسير عطاء الخراساني",
                  "match": ["عطاء الخراساني"], "exclude": []},
    "thawri":    {"merged": True, "name": "Тафсир Суфьяна ас-Саури", "nameAr": "تفسير سفيان الثوري",
                  "match": ["سفيان الثوري"], "exclude": []},   # «سفيان» без нисбы — неоднозначно, идёт в прочие
    "zuhri":     {"merged": True, "name": "Тафсир аз-Зухри", "nameAr": "تفسير الزهري",
                  "match": ["محمد ابن شهاب الزهري", "ابن شهاب الزهري", "الزهري"], "exclude": []},
    "jabir":     {"merged": True, "name": "Тафсир Джабира ибн Абдуллаха", "nameAr": "تفسير جابر بن عبد الله",
                  "match": ["جابر بن عبد الله"], "exclude": []},
    "abu_aliya": {"merged": True, "name": "Тафсир Абу-ль-Алии", "nameAr": "تفسير أبي العالية",
                  "match": ["أبي العالية", "أبو العالية"], "exclude": []},
    "abu_malik": {"merged": True, "name": "Тафсир Абу Малика аль-Гифари", "nameAr": "تفسير أبي مالك الغفاري",
                  "match": ["أبي مالك غزوان", "أبي مالك الغفاري"], "exclude": []},
    "ibn_musayyab":{"merged": True, "name": "Тафсир Саида ибн аль-Мусаййаба", "nameAr": "تفسير سعيد بن المسيب",
                  "match": ["سعيد بن المسيب"], "exclude": []},
    "abu_saeed": {"merged": True, "name": "Тафсир Абу Саида аль-Худри", "nameAr": "تفسير أبي سعيد الخدري",
                  "match": ["أبي سعيد الخدري"], "exclude": []},
    "umar":      {"merged": True, "name": "Тафсир Умара ибн аль-Хаттаба", "nameAr": "تفسير عمر بن الخطاب",
...
def others_matcher():
    ...
    """
    hits = [matcher(sp) for sid, sp in SCHOLARS.items()
            if not sp.get("others") and not sp.get("merged")]
...
def main():
    ...
    for sid in args:
        if sid == "--all":
            for k, sp in SCHOLARS.items():
                if not sp.get("merged"):
                    build(k, data)
            continue
        if sid not in SCHOLARS:
            print(f"  ✗ нет в реестре: {sid} (есть: {', '.join(SCHOLARS)})")
            continue
        if SCHOLARS[sid].get("merged"):
            print(f"  ℹ {sid} сведён в athar_misc — отдельным источником не собирается "
                  f"(снять \"merged\", если решено вернуть)")
            continue
        build(sid, data)
